...
<section class="row my-3">
    <section class="col-12">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" id="summary" name="summary" placeholder="Headline ..." rows="3" required autofocus></textarea>
        </div>

        <div class="form-group">
            <label for="body">Artikel</label>
            <textarea class="form-control" id="body" name="body" placeholder="Artikel ..." rows="5" required autofocus></textarea>
        </div>

                ...
                <div class="row">
                    <div class="col-lg-8 post-list">
                        ...
                        <div class="latest-post-wrap">
                            <h4 class="cat-title post-left text-left"style="background-color:#1C1B6C">Latest News</h4>
                        ...
                        <div class="popular-post-wrap">
                            <h4 class="title post-left text-left" style="background-color:#1C1B6C">Popular News</h4>
